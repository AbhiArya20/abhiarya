...
export default function SocialV1() {
  return (
    <div className="text-muted-foreground flex gap-1 pt-1 font-mono text-sm print:flex-wrap">
      <TooltipProvider>
              ...
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={cn(
                    ...
                    social.withText ? "px-2" : "h-8 w-8 print:h-auto print:w-auto print:px-2"
                  )}
                >
                  <Icon className={social.icon === "github" ? "size-5" : "size-4"} />
                  <span className="hidden print:inline">{social.name}</span>

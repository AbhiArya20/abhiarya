...
A Software Developer with years of experience in the JavaScript ecosystem, Python, and Flutter, building scalable and
meaningful projects.
...
<span style="font-size: 0.8em;">This repository intentionally doesn't follow the DRY (Don't Repeat Yourself) principle
in order to maintain separate versions of each component.</span>
